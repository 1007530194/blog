...
class DataLoader(object):
    def __init__(self, FILE_jdata_sku_basic_info, FILE_jdata_user_action, FILE_jdata_user_basic_info,
                 FILE_jdata_user_comment_score, FILE_jdata_user_order):
...
class Features(object):
    ...
    def MakeFeature_Order_Comment_(self, FeatureMonthBegin, FeatureMonthEnd, BetweenFlag):
        """
        # Order Comment User Sku
    ...
    def MakeFeature_Action_(self, FeatureMonthBegin, FeatureMonthEnd, BetweenFlag):
        # Action User Sku
        '''
        ...
        def make_feature_order_comment(self, FeatureMonthBegin, FeatureMonthEnd, BetweenFlag):
            ...
            features_temp_ = \
                features_temp_Order_[(features_temp_Order_['cate'] == 30) | (features_temp_Order_['cate'] == 101)] \
                    ...
                    .rename(columns={'user_id': 'user_id', 'o_id': BetweenFlag + 'o_id_cate_30_101_cnt'})
            self.data_BuyOrNot_FirstTime = self.data_BuyOrNot_FirstTime \
                .merge(features_temp_, on=['user_id'], how='left')
            ...
            features_temp_ = \
                features_temp_Order_[(features_temp_Order_['cate'] == 30) | (features_temp_Order_['cate'] == 101)]. \
                    ...
                    reset_index(). \
                    rename(columns={'user_id': 'user_id', 'o_date': BetweenFlag + 'o_date_cate_30_101_nuique'})
            self.data_BuyOrNot_FirstTime = self.data_BuyOrNot_FirstTime.merge(features_temp_, on=['user_id'],
                                                                              how='left')
